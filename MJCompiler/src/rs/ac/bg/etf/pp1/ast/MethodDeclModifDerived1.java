...
public class MethodDeclModifDerived1 extends MethodDeclModif {

    private FormParsOptional FormParsOptional;
    private VarDeclList VarDeclList;
    private StatementList StatementList;

    public MethodDeclModifDerived1 (FormParsOptional FormParsOptional, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclModifDerived1(\n");
