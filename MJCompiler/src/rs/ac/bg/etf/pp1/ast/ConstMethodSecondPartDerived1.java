...
public class ConstMethodSecondPartDerived1 extends ConstMethodSecondPart {

    private FormParsOptional FormParsOptional;
    private VarDeclList VarDeclList;
    private StatementList StatementList;

    public ConstMethodSecondPartDerived1 (FormParsOptional FormParsOptional, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstMethodSecondPartDerived1(\n");
