...
public class MethodRestDerived2 extends MethodRest {

    private ConstMethodSecondPart ConstMethodSecondPart;
    private MethodRest MethodRest;

    public MethodRestDerived2 (ConstMethodSecondPart ConstMethodSecondPart, MethodRest MethodRest) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodRestDerived2(\n");
