...
public class ConstrMethodBothMethodIdentPart extends ConstrMethodBothOptional {

    private ConstMethodSecondPart ConstMethodSecondPart;
    private MethodRest MethodRest;

    public ConstrMethodBothMethodIdentPart (ConstMethodSecondPart ConstMethodSecondPart, MethodRest MethodRest) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstrMethodBothMethodIdentPart(\n");
