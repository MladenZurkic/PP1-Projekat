...
public class DesignatorStatementOptionalDerived2 extends DesignatorStatementOptional {

    private ActParsOptional ActParsOptional;

    public DesignatorStatementOptionalDerived2 (ActParsOptional ActParsOptional) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementOptionalDerived2(\n");
