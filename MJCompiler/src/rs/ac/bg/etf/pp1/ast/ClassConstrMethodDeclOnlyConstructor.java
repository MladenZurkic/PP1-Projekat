...
public class ClassConstrMethodDeclOnlyConstructor extends ClassConstrMethodDecl {

    private ConstructorDeclList ConstructorDeclList;

    public ClassConstrMethodDeclOnlyConstructor (ConstructorDeclList ConstructorDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassConstrMethodDeclOnlyConstructor(\n");
