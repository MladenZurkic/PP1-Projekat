...
public class ConstrDeclModifDerived1 extends ConstrDeclModif {

    private FormParsOptional FormParsOptional;
    private VarDeclList VarDeclList;
    private StatementList StatementList;

    public ConstrDeclModifDerived1 (FormParsOptional FormParsOptional, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstrDeclModifDerived1(\n");
