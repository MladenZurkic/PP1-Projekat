...
public class ActParsParenOptionalDerived1 extends ActParsParenOptional {

    private ActParsParen ActParsParen;

    public ActParsParenOptionalDerived1 (ActParsParen ActParsParen) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActParsParenOptionalDerived1(\n");
