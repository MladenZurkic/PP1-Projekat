...
public class ClassConstrMethodDeclDef extends ClassConstrMethodDecl {

    private ConstrMethodBothOptional ConstrMethodBothOptional;

    public ClassConstrMethodDeclDef (ConstrMethodBothOptional ConstrMethodBothOptional) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassConstrMethodDeclDef(\n");
