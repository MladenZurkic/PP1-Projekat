...
public class ConstMethodSecondPart implements SyntaxNode {
    ...
    public ConstMethodSecondPart (FormParsOptional FormParsOptional, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstMethodSecondPart(\n");
