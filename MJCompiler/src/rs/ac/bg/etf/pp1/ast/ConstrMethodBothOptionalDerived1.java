...
public class ConstrMethodBothOptionalDerived1 extends ConstrMethodBothOptional {

    private ConstMethodSecondPart ConstMethodSecondPart;
    private ConstrMethodBothOptional ConstrMethodBothOptional;

    public ConstrMethodBothOptionalDerived1 (ConstMethodSecondPart ConstMethodSecondPart, ConstrMethodBothOptional ConstrMethodBothOptional) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstrMethodBothOptionalDerived1(\n");
