...
public class MethodRestVoid extends MethodRest {

    private ConstMethodSecondPart ConstMethodSecondPart;
    private MethodRest MethodRest;

    public MethodRestVoid (ConstMethodSecondPart ConstMethodSecondPart, MethodRest MethodRest) {
