...
public class VarDeclListBasicDerived1 extends VarDeclListBasic {

    private VarDeclComma VarDeclComma;
    private VarDeclListBasic VarDeclListBasic;

    public VarDeclListBasicDerived1 (VarDeclComma VarDeclComma, VarDeclListBasic VarDeclListBasic) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclListBasicDerived1(\n");
