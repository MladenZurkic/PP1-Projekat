...
public class ConstructorDeclLists extends ConstructorDeclList {

    private ConstructorDeclList ConstructorDeclList;
    private ConstructorDecl ConstructorDecl;

    public ConstructorDeclLists (ConstructorDeclList ConstructorDeclList, ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstructorDeclLists(\n");
