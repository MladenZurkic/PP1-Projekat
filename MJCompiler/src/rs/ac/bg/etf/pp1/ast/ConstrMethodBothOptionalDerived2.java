...
public class ConstrMethodBothOptionalDerived2 extends ConstrMethodBothOptional {

    private ConstMethodSecondPart ConstMethodSecondPart;
    private MethodRest MethodRest;

    public ConstrMethodBothOptionalDerived2 (ConstMethodSecondPart ConstMethodSecondPart, MethodRest MethodRest) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstrMethodBothOptionalDerived2(\n");
