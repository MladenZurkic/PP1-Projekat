...
public class MethodRestIdent extends MethodRest {

    private ConstMethodSecondPart ConstMethodSecondPart;
    private MethodRest MethodRest;

    public MethodRestIdent (ConstMethodSecondPart ConstMethodSecondPart, MethodRest MethodRest) {
