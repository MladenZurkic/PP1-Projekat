...
public class VarDeclListBasicDerived2 extends VarDeclListBasic {

    private VarDeclEnd VarDeclEnd;

    public VarDeclListBasicDerived2 (VarDeclEnd VarDeclEnd) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclListBasicDerived2(\n");
