...
public class ConstrMethodBothMethodVoidPart extends ConstrMethodBothOptional {

    private ConstMethodSecondPart ConstMethodSecondPart;
    private MethodRest MethodRest;

    public ConstrMethodBothMethodVoidPart (ConstMethodSecondPart ConstMethodSecondPart, MethodRest MethodRest) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstrMethodBothMethodVoidPart(\n");
